/*
 * Copyright (C) 2012 Square, Inc. Copyright (C) 2007 The Guava Authors
 * 
 ...
 * 
 * <p>
 * Events are routed based on their type &mdash; an event will be delivered to any handler for any type to which the
 ...
 * 
 * <p>
 * The Bus by default enforces that all interactions occur on the main thread. You can provide an alternate enforcement
 * by passing a {@link ThreadEnforcer} to the constructor.
 * 
 ...
 * 
 * <h2>Dead Events</h2>
 * If an event is posted, but no registered handlers can accept it, it is considered "dead." To give the system a second
 * chance to handle dead events, they are wrapped in an instance of {@link com.squareup.otto.DeadEvent} and reposted.
 * 
 * <p>
...
public class Bus {
	 ...
	 * 
	 * @param identifier
	 *            a brief name for this bus, for debugging purposes. Should be a valid Java identifier.
	 */
	 ...
	 *            A brief name for this bus, for debugging purposes. Should be a valid Java identifier.
	 * @param handlerFinder
	 *            Used to discover event handlers and producers when registering/unregistering an object.
	 */
	 ...
	 * <p>
	 * If any subscribers are registering for types which already have a producer they will be called immediately with
	 * the result of calling that producer.
	 * <p>
	 ...
	 * 
	 * @param object
	 *            object whose producer and handler methods should be unregistered.
	...
	protected void dispatchQueuedEvents () {
		// don't dispatch if we're already dispatching, that would allow reentrancy and out-of-order events. Instead,
		// leave
